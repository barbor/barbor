...
Dado /^que o conteudista publica a campanha '(.+)' com URL amigável '(.+)', sob o tema '(.+)', com a regionalização '(.+)'$/ do |campaign_title, campaign_url, campaign_theme, campaign_skipregionalization|
  visit MangoPublishCampaignPage do |page| page.publish_campaign campaign_title, campaign_url, campaign_theme, campaign_skipregionalization end
end
