...
class ArborMediaPage
  ...
  in_iframe :id => 'mediaBrowser' do |media_frame|
    ...
    link :library, :href => '#media-tab-media_default--media_browser_1', :frame => media_frame
    ...
    #label :choosen_media, :text => 'teste.pdf', :frame => media_frame

    div :choosen_media, :class => 'media-item', :frame => media_frame
