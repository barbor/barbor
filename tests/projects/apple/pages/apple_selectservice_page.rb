...
class AppleSelectServicePage 
  ...
  select_list :node_service_type_field, :name => 'service_type' 

  select_list :node_service_region_field, :name => 'region'

  
  #link :description_type_chosen_link, :class => 'chzn-single', :index => 1
  
  button :select, :name => 'op'
  ...
  def select_service service_type, service_region
  ...
  #def add_product_description_type product_description_type
    ...
    self.execute_script("document.getElementById('edit-service-type').style.display = 'block';")
    
    self.node_service_type_field = service_type

    self.execute_script("document.getElementById('edit-service-type').style.display = 'none';")

    self.execute_script("document.getElementById('edit-region').style.display = 'block';")

    self.node_service_region_field = service_region

    self.execute_script("document.getElementById('edit-region').style.display = 'none';")
